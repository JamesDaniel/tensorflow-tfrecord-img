#code taken and modified from: https://github.com/tensorflow/models/blob/master/inception/inception/data/build_image_data.py
...
tf.app.flags.DEFINE_integer('train_shards', 53,
                            'Number of shards in training TFRecord files.')
tf.app.flags.DEFINE_integer('validation_shards', 53,
